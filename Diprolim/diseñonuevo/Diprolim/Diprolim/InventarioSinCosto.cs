...
namespace Diprolim
{
    public partial class InventarioSinCosto : Form
    {
        conexion conn = new conexion();
        double costoPTotaln = 0, costoVTotal = 0, sumaCP = 0, sumaPV = 0;
        String aux = "";
        public InventarioSinCosto()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            comando = new MySqlCommand("select a.codigo,a.descripcion,a.valor_medida,c.nombre,a.cantidad,a.precio_calle from articulos a,"+
                " unidad_medida c where " + aux +str_depto+exist+ "a.unidad_medida_id=c.id", conectar);
            ...
            while (lector.Read())
            {
                ...
                costoVTotal = Convert.ToDouble(lector.GetString(4)) * Convert.ToDouble(lector.GetString(5));
                Tabla.Rows.Add(lector.GetString(0), lector.GetString(1), lector.GetString(2) + " " + lector.GetString(3), lector.GetDouble(4),lector.GetDouble(5), costoVTotal);
                sumaPV += costoVTotal;
            }
            conectar.Close();
            Tabla.Rows.Add("", "", "", "", "Totales", "$" + sumaPV.ToString());
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                oSheet.Cells[2, 5] = invPrecioV.HeaderText;
                oSheet.Cells[2, 6] = invPrecioTotal.HeaderText;
        ...
        private void InventarioSinCosto_Load(object sender, EventArgs e)
        {
            sumaCP = 0;
            sumaPV = 0;
            Tabla.Rows.Clear();
            ...
            MySqlConnection conectar = conn.ObtenerConexion();
            MySqlCommand comando;
            comando = new MySqlCommand("select a.codigo,a.descripcion,a.valor_medida,c.nombre,a.cantidad,a.precio_calle from articulos a, unidad_medida c where " + aux + "a.unidad_medida_id=c.id", conectar);
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            if (Tabla.Rows.Count > 0)
            {
                ...
                #region fecha
                e.Graphics.DrawString(DateTime.Now.ToString("dd/MMMM/yyyy"), new Font("Arial", 10), Brushes.Black, new Rectangle(540 + x, 75, 500, Tabla.Rows[0].Height + 15));
                #endregion
        ...
        private void tbxFiltro_KeyDown_1(object sender, KeyEventArgs e)
        {
            sumaCP = 0;
            sumaPV = 0;
            Tabla.Rows.Clear();
