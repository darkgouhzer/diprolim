            ...
            else
            {
                                   ...
                                   (rbProductos.Checked || rbAccesorios.Checked || rbPapel.Checked) && cbxFamilia.SelectedValue != null)
                {
                    ...
                    if (Convert.ToInt32(tbxDesc.Tag) != 0)
                    {
                        ...
                        if (tbl.Rows.Count > 0)
                        {
                            if (!objArticuloBO.ValidarExisteDescripcionAGranel(Convert.ToInt32(tbxDesc.Tag), Convert.ToInt32(cbxUMedida.SelectedValue), Convert.ToDouble(tbxVMedida.Text), "UPDATE"))
                            {
                        ...
                        {
                            if (!objArticuloBO.ValidarExisteDescripcionAGranel(Convert.ToInt32(tbxDesc.Tag), Convert.ToInt32(cbxUMedida.SelectedValue), Convert.ToDouble(tbxVMedida.Text), "INSERT"))
                            {
